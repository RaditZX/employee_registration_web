  ...
  return (
    ...
    <form id="registration-form" onSubmit={handleSubmit(onSubmit)} className="rounded-lg border border-slate-200 bg-white p-6 sm:p-8">
      <div className="border-b border-slate-200 pb-6">
        ...
        <h1 className="mt-2 text-[32px] font-semibold leading-10 tracking-[-0.02em] text-slate-950">Registrasi Karyawan Baru</h1>
        ...
        >
          <div
            className={`mx-auto flex h-14 w-14 items-center justify-center rounded-full text-2xl font-semibold ${
              submitModal.type === 'success' ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700'
            }`}
            aria-hidden="true"
          >
          ...
          <button
            ...
            className={`mt-6 inline-flex min-h-11 w-full items-center justify-center rounded-lg px-5 py-3 text-sm font-semibold text-white transition focus:outline-none focus:ring-4 sm:w-auto ${
              submitModal.type === 'success'
